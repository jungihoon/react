    ...
    <>
      ...
      <header className={upDown ? "down" : "up"}>
        <div className="header_inner">
          <h1>
            <NavLink to="/">
              <img src={img1} alt="코레일 로고" />
              <span className="hidden">코레일</span>
            </NavLink>
          </h1>
          <nav id="gnb" className={isSwitched ? "show" : "hide"}>
            ...
            <ul>
              ...
              <li>
                <NavLink to="/Fee">열차운임표</NavLink>
              </li>
              <li>
                <NavLink to="/Place">역위치정보</NavLink>
              </li>
            </ul>
          </nav>
